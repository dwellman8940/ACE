    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<bool>> DefaultBooleanProperties =
            DictOf(
                ...
                ("fellowship_rewards_ignore_distance", new Property<bool>(false, "if true, fellowship rewards (xp, loot, luminance) are shared regardless of distance or dungeons"))
                );
        ...
        public static readonly ReadOnlyDictionary<string, Property<long>> DefaultLongProperties =
            DictOf(
                ...
                ("allegiance_xp_vassals_for_max_passup", new Property<long>(4, "how many vassals are required for maximum xp received from passup, retail was 4"))
                );
        ...
        public static readonly ReadOnlyDictionary<string, Property<double>> DefaultDoubleProperties =
            DictOf(
                ...
                ("item_mana_usage_mod", new Property<double>(1.0, "scales the amount of mana items consume."))
                );
